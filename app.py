...
def create_app(test_config=None):
    ...
    def create_actor(payload):
        ...
        existing_actor = Actor.query.filter(Actor.name == new_name)
        .one_or_none()
        if existing_actor:
            abort(400)
        try:
    ...
    def create_movie(payload):
        try:
            ...
            existing_movie = Movie.query.filter(Movie.title == new_title)
            .one_or_none()
            if existing_movie:
                abort(400)
    ...
    def patch_actors(payload, id):
        ...
        try:
            ...
            if patch_name is None and patch_age is None
            and patch_gender is None:
                abort(400)
